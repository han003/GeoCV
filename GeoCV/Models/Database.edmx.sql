...
-- --------------------------------------------------
-- Date Created: 04/22/2015 03:54:36
-- Generated from EDMX file: C:\Users\Jago\Documents\Visual Studio 2013\Projects\GeoCV\GeoCV\GeoCV\Models\Database.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[ListeKatalog]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ListeKatalog];
GO
...
CREATE TABLE [dbo].[Arbeidserfaring] (
    ...
    [Nåværende] bit  NOT NULL,
    [Fra] smallint  NOT NULL,
    [Til] smallint  NOT NULL,
